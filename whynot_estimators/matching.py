...
class Matching(whynot_estimators.Estimator):
    ...
    def estimate_treatment_effect(self, covariates, treatment, outcome,
                                  distance="mahalanobis", errors="abadie_imbens"):
        ...
        return InferenceResult(ate=ate, individual_effects=None, stderr=stderr,
                               ci=conf_int, elapsed_time=stop_time - start_time)
